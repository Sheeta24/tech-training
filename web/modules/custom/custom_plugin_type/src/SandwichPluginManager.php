...
use Drupal\custom_plugin_type\Annotation\Sandwich;
 ...
 * custom_plugin_type.services.yml so that it can be easily accessed and used
...
class SandwichPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    // see custom_plugin_type_sandwich_info_alter().
    ...
    // service be used in the custom_plugin_type.services.yml file. The second
