...
class TermListBuilder extends EntityListBuilder {
  ...
  public function render() {
    $dictionary_storage = \Drupal::entityTypeManager()->getStorage('dictionary_term');
    $count = $dictionary_storage->getTotalDictionaryTerms();
    $build['description'] = array(
      '#markup' => $this->t(' We have total @count dictionary term entities.', array(
        '@count' => $count,
      )),
    );
